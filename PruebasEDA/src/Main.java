...
public class Main {
	public static void main(String[] args) {
		...
		Nodo nodo61 = new Nodo(6,nodo9,nodo1);
		Nodo nodo5 = new Nodo(5,nodo62,null);
		Nodo root = new Nodo(7,nodo5,nodo61);
		
		ArbolBinario arbolPeso = new ArbolBinario(root);
		System.out.println(arbolPeso.caminoMasPesado());
